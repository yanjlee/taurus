...
setuptools.setup(
    ...
    description="A cryptocurrency trading microservice for a deep learning trader. Does intelligent wrapping for CCXT on GDAX.",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/taurus",  # 模块github地址
